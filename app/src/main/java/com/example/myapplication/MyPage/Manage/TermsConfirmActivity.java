...
public class TermsConfirmActivity extends AppCompatActivity {

    @SuppressLint("SetTextI18n")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_terms_confirm);
        ...
        TextView textViewTerms = findViewById(R.id.textView_terms);
        TextView textViewPrivacy = findViewById(R.id.textView_privacy);
